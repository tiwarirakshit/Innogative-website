    ...
    <>
      ...
      <div id="banner" className="h-screen bg-[#121214] w-full relative">
        <div className="absolute z-[100] w-full h-full flex flex-col items-center justify-center opacity-1 px-4">
          <p className="text-white text-4xl md:text-6xl lg:text-8xl hover-target text-center">Innogative</p>
          <p className="text-white font-light font-sans text-xs md:text-sm tracking-[8px] md:tracking-[13px] mt-3 uppercase text-center">Grow with Innovation</p>
        </div>
        ...
        <video src={Intro} autoPlay muted loop className="w-full h-full object-cover"></video>
      </div>

      <div id="home" className="min-h-screen flex items-center justify-center bg-customblack py-12 px-4">
        <section className="text-white w-full md:w-10/12 mx-auto">
          ...
          <div className="flex flex-col gap-4 mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-gray-800 bg-white text-center font-semibold py-1 px-3 rounded-2xl text-sm">SaaS</span>
              <span className="text-gray-800 bg-white text-center font-semibold py-1 px-3 rounded-2xl text-sm">FinTech</span>
              <span className="text-gray-800 bg-white text-center font-semibold py-1 px-3 rounded-2xl text-sm">Healthcare</span>
              <span className="text-gray-800 bg-white text-center font-semibold py-1 px-3 rounded-2xl text-sm">EdTech</span>
            </div>
          </div>

          <h1 className="text-3xl md:text-4xl lg:text-[80px] leading-tight md:leading-[100px] font-bold mb-8 w-full lg:w-4/6">
            Get <span className="text-blue-500">user experience</span><br /> design
            that becomes <br /> your
            <span className="text-blue-500"> competitive <br />advantage</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
            {services.map((service, index) => (
              <div key={index} className="group relative bg-white p-6 md:p-8 rounded-lg shadow-lg transition-all duration-300 hover:bg-gray-900">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                  <div className="relative z-10 flex-1 text-center md:text-left">
                    <h3 className="text-xl md:text-2xl font-bold mb-4 group-hover:text-white">{service.title}</h3>
                    <p className="group-hover:text-white text-sm md:text-base">{service.description}</p>
                  </div>

                  <div className="relative z-10 w-32 md:w-48">
                    <img src={service.image} alt={service.title} className="w-full h-32 md:h-48 object-contain group-hover:hidden" />
                    <img src={service.image2} alt={service.title} className="w-full h-32 md:h-48 object-contain hidden group-hover:block" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
            <div className="lg:w-[80%] group relative bg-white p-6 md:p-8 rounded-lg shadow-lg transition-all duration-300 hover:bg-gray-900">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                <div className="relative z-10 flex-1 text-center md:text-left">
                  <h3 className="text-xl md:text-2xl font-bold mb-4 group-hover:text-white">{websiteDesign.title}</h3>
                  <p className="group-hover:text-white text-sm md:text-base">{websiteDesign.description}</p>
                </div>

                <div className="relative z-10 w-32 md:w-48">
                  <img src={websiteDesign.image} alt={websiteDesign.title} className="w-full h-32 md:h-48 object-contain group-hover:hidden" />
                  <img src={websiteDesign.image2} alt={websiteDesign.title} className="w-full h-32 md:h-48 object-contain hidden group-hover:block" />
                </div>
              </div>
            </div>
      ...
      <section className="mt-20 p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full md:w-10/12 mx-auto">
          <div className="relative bg-gray-100 text-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-900 hover:text-white transition duration-300">
            <h3 className="text-3xl md:text-4xl font-semibold mb-8 md:mb-12">SaaS</h3>
            ...
            <div className="absolute top-4 right-4">
              <a href="#" className="text-xl hover:scale-105 transition transform duration-200">
                <svg fill="none" height="20" viewBox="0 0 9 10" width="15" xmlns="http://www.w3.org/2000/svg">
                  <path clipRule="evenodd" d="m.455752.5h8.544248v8.54425h-1.28906v-6.34368l-6.799434 6.79943-.911506-.91151 6.79943-6.79943h-6.343678z" fill="currentColor" fillRule="evenodd"></path>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="relative bg-gray-100 text-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-900 hover:text-white transition duration-300">
            <h3 className="text-3xl md:text-4xl font-semibold mb-8 md:mb-12">Healthcare</h3>
            <p className="text-base md:text-xl mb-4">
          ...
          <div className="relative bg-gray-100 text-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-900 hover:text-white transition duration-300">
            <h3 className="text-3xl md:text-4xl font-semibold mb-8 md:mb-12">Content Creation</h3>
            <p className="text-base md:text-xl mb-4">
          ...
          <div className="relative bg-gray-100 text-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-900 hover:text-white transition duration-300">
            <h3 className="text-3xl md:text-4xl font-semibold mb-8 md:mb-12">UI/UX</h3>
            <p className="text-base md:text-xl mb-4">
