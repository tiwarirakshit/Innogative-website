...
const Home = () => {
  ...
  useEffect(() => {
    // Check if the screen width is greater than 300px (for mobile screens)
    if (window.innerWidth <= 300) {
      return; // Disable the mouse movement tracking on mobile
    }
          ...
          <section className="text-white w-full md:w-10/12 mx-auto">
            ...
            <div className="flex w-full mt-8 md:mt-12">
              <p className="text-lg md:text-2xl w-full lg:w-1/2 lg:ml-auto">
                Achieve product growth with our data-driven design and
                development solutions that avoid common pitfalls, ensuring your
                SME succeeds in the market.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full md:w-10/12 mx-auto">
            <div className="relative bg-gray-100 text-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-900 hover:text-white transition duration-300">
              ...
              <p className="text-base md:text-xl mb-4">
                ...
                and tailored to meet your users' needs, ensuring they stay
            ...
            <div className="relative bg-gray-100 text-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-900 hover:text-white transition duration-300">
              ...
              <p className="text-base md:text-xl mb-4">
                We deliver ERP systems that integrate business processes,
                improve resource management, and provide real-time insights,
                helping organizations achieve operational efficiency and
